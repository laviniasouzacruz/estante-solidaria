          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
            ...
            <div class="offcanvas-body">
              <ul id="navbar"
                ...
                <li class="nav-item">
                  <a class="nav-link me-4 active" href="index.html">Início</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-4" href="index.html">Sobre</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-4" href="index.html">Livros</a>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu animate slide border">
                    <li>
                      <a href="index.html" class="dropdown-item fw-light">Ficção</a>
                    </li>
                    <li>
                      <a href="index.html" class="dropdown-item fw-light">Poesia</a>
                    </li>
                    <li>
                      <a href="index.html" class="dropdown-item fw-light">Romance</a>
                    </li>
                    <li>
                      <a href="index.html" class="dropdown-item fw-light">Suspense e Terror</a>
                    </li>
                    <li>
                      <a href="index.html" class="dropdown-item fw-light">Automação e Mecânica</a>
                    </li>
                    <li>
                      <a href="index.html" class="dropdown-item fw-light">Informática e Tecnologia</a>
                    </li>
                    <li>
                      <a href="index.html" class="dropdown-item fw-light">Livros Educacionais e Didáticos</a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item">
